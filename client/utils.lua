...
-- @param name The name of the model to search for. If a list of names is given, then the closest in that list will be returned
-- @param radius The radius to search from
-- @param coords The coords to pass. If excluded, then the current player coords are used
